...
from apps.farms.models import Farm, Field, Crop, CropCycle
...
class Recommendation(models.Model):
    ...
    field = models.ForeignKey(Field, on_delete=models.CASCADE, related_name='recommendations', null=True, blank=True)
